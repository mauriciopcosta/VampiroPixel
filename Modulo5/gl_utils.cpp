...
bool start_gl () {
	...
	// Forçar a versão do OpenGL (opcional, mas bom para compatibilidade)
	...
	g_window = glfwCreateWindow (
		g_gl_width, g_gl_height, "Animacao de Sprite", NULL, NULL
	);
	if (!g_window) {
    ...
    // --- CORREÇÃO AQUI: Trocando a inicialização da GLEW pela da GLAD ---
